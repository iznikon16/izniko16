...
select ok((select invoice_number::text like 'SBL-%' from public.invoices where order_id='51000000-0000-0000-0000-000000000020' and document_type='sales_document'),'sales document receives SBL number');
