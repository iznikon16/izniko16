...
const integrations = [
  ...
  { key: 'odeal', label: 'Ödeal', href: '/admin/integrations/odeal', Icon: WalletCards, callback: '/api/payments/odeal', adapter: 'Canlı adaptör doğrulaması 22B’de' },
