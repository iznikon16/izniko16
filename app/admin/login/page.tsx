...
export default async function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen bg-[#090e1a] text-slate-100 font-sans selection:bg-indigo-500/30 selection:text-indigo-200">
      {/* Background Decorator */}
      <div className="relative overflow-hidden min-h-screen flex flex-col justify-between">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(99,102,241,0.18),transparent_45%),radial-gradient(ellipse_at_bottom_right,rgba(15,23,42,0.9),#090e1a)]" />
        <div className="absolute inset-0 opacity-[0.05] bg-[linear-gradient(rgba(255,255,255,0.1)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.1)_1px,transparent_1px)] bg-[size:48px_48px]" />
        ...
        <header className="relative z-10 mx-auto w-full max-w-7xl px-6 pt-8 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <span className="hidden sm:inline-block border-l border-slate-700 pl-3 text-xs font-bold tracking-widest text-slate-400 uppercase">
              B2B Toptan Portalı
            </span>
          </Link>
          ...
          <Link
            href="/"
            className="inline-flex items-center gap-2 rounded-xl border border-slate-800 bg-slate-900/80 px-4 py-2 text-xs font-bold text-slate-300 backdrop-blur-md transition-all hover:border-indigo-500/50 hover:text-indigo-400 hover:shadow-lg hover:shadow-indigo-500/10"
          >
            &lsaquo; Mağazaya Dön
          </Link>
        </header>
        ...
        <div className="relative z-10 mx-auto grid w-full max-w-7xl items-center gap-12 px-6 py-12 lg:grid-cols-12 lg:py-16">
          ...
          <section className="flex flex-col justify-center lg:col-span-7">
            <div className="inline-flex w-fit items-center gap-2.5 rounded-full border border-indigo-500/30 bg-indigo-500/10 px-4 py-1.5 backdrop-blur-md">
            ...
            <h1 className="mt-6 text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl leading-[1.1]">
              Nalbur &amp; Hırdavat Toptancılığında <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 via-violet-400 to-purple-400">Dijital Güç</span>
            </h1>

            <p className="mt-5 text-base text-slate-300 sm:text-lg leading-relaxed max-w-2xl">
            ...
            <div className="mt-10 grid gap-4 sm:grid-cols-3">
              {loginHighlights.map(({ icon: Icon, title, description }) => (
                <article
                  key={title}
                  className="group rounded-2xl border border-slate-800/80 bg-slate-900/60 p-5 backdrop-blur-md transition-all hover:border-indigo-500/40 hover:bg-slate-900/90"
                >
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 group-hover:scale-110 transition-transform">
          ...
          <section className="lg:col-span-5 flex justify-center">
            <div className="w-full max-w-md rounded-3xl border border-slate-800 bg-slate-900/90 p-8 sm:p-10 shadow-2xl shadow-black/80 backdrop-blur-xl relative overflow-hidden">
              {/* Top Accent Line */}
              <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-indigo-500 via-violet-400 to-purple-500" />
              ...
              <div className="mt-8 border-t border-slate-800/80 pt-5 text-center">
                <p className="text-xs text-slate-500">
                  ...
                  <Link href="/toptan-musteri-ol" className="font-bold text-indigo-400 hover:underline">
                    Bayi Olun &rsaquo;
                  </Link>
                </p>
              </div>
        ...
        <footer className="relative z-10 mx-auto w-full max-w-7xl px-6 py-6 border-t border-slate-800/60 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-6">
            <Link href="/iletisim" className="hover:text-indigo-400 transition-colors">Destek &amp; İletişim</Link>
            <Link href="/toptan-musteri-ol" className="hover:text-indigo-400 transition-colors">Toptan Bayilik</Link>
          </div>
        </footer>
      </div>
    </div>
