...
export default function CategoryClient({ products: allProducts }: { products: any[] }) {
  ...
  const filtered = useMemo(() => {
    ...
    return result;
  }, [allProducts, appliedSearch, selectedBrands, sortBy]);
  ...
  return (
    <>
      ...
      <main className="main container">
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", background: "#f8fafc", padding: "1rem", borderRadius: "12px", marginBottom: "1.5rem", border: "1px solid #e2e8f0", flexWrap: "wrap", gap: "1rem" }}>
          
          <div style={{ display: "flex", alignItems: "center", gap: "1rem", flexWrap: "wrap" }}>
            <span style={{ fontWeight: "700", color: "#0f172a", fontSize: "0.9rem" }}>Marka:</span>
            {uniqueBrands.map(brand => (
              <label key={brand} style={{ display: "flex", alignItems: "center", gap: "0.3rem", fontSize: "0.85rem", cursor: "pointer", color: "#475569" }}>
                <input 
                  type="checkbox" 
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
            ...
            <select 
              ...
              style={{ padding: "0.4rem 0.8rem", borderRadius: "8px", border: "1px solid #cbd5e1", fontSize: "0.85rem", color: "#0f172a", outline: "none", fontWeight: "600", cursor: "pointer", background: "white" }}
            >
        ...
        <div className="b2b-grid" style={{ gridTemplateColumns: "repeat(5, 1fr)" }}>
          {filtered.map((product) => (
            ...
            >
              ...
              >
                <Link href={`/urun/${product.slug || product.id}`} style={{ color: "inherit", textDecoration: "none" }}>
                  {product.name}
                </Link>
              </div>
